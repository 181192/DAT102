...
import no.hib.dat102.liste.DobbelKjedetOrdnetListeS;
...
public class KlientDobbeltOrdnetKjedetS{
 ...
 DobbelKjedetOrdnetListeS <String>liste = new DobbelKjedetOrdnetListeS<String>(new String("AAA"), new String("zzz"));
